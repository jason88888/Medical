...
<div class="pageContent">
    <form method="post" action="policy/save" class="pageForm required-validate"
            ...
            <ul>
                ...
                <li>
                    <div class="buttonActive">
                        <div class="buttonContent"><a href="policy/form?id=${policy.id}" target="dialog" rel="form"
                                                      width="800" height="400">编辑</a></div>
                    </div>
                </li>
                <li>
                    <div class="button">
