    ...
    <form method="post" action="cgrkorder/save" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
        <div class="pageFormContent" layoutH="56" autocomplete="off">
            ...
            <p>
                ...
                <input type="text" class="required" value="${cgrkorder.warehouseName}" name="warehouse.name"
            ...
            <p>
                ...
                <input type="text" class="required" value="${cgrkorder.medicineName}" name="medicine.name" rel="lookup"
            ...
            <p>
                ...
                <input type="text" class="required" value="${cgrkorder.operatorName}" name="user.username" rel="lookup"
            ...
            <p>
                ...
                <input type="text" class="required" value="${cgrkorder.agentName}" name="agent.name" rel="lookup"
            ...
            <p>
                ...
                <input type="text" class="required" value="${cgrkorder.commercialCompanyName}"
            ...
            <p>
                ...
                <input type="text" class="required" value="${cgrkorder.providerName}" name="provider.name" rel="lookup"
            ...
            <p>
                <label>实际单价：</label>
                <input name="unitPrice" value="${cgrkorder.unitPrice}" type="text" autocomplete="off" size="30"
                       alt="请输入实际单价"/>
            </p>

            <p>
                <label>高开单价：</label>
                <input name="highUnitPrice" value="${cgrkorder.highUnitPrice}" type="text" autocomplete="off" size="30"
                       alt="请输入高开单价"/>
            </p>
            ...
            <p>
                <label>采购申请单号：</label>
                <input name="orderCode" class="required" type="text" value="${cgrkorder.orderCode}" autocomplete="off"
                       size="30" alt="请输入采购申请单号"/>
            </p>

            <p>
                <label>采购单价：</label>
                <input name="purchasePrice" type="text" value="${cgrkorder.purchasePrice}" autocomplete="off" size="30"
                       alt="请输入采购单价"/>
            </p>

            <p>
                <label>付款金额：</label>
                <input name="purchasePrice" type="text" value="${cgrkorder.purchaseMoney}" autocomplete="off" size="30"
                       alt="请输入付款金额"/>
            </p>
            ...
            <p>
                <label>付税方式：</label>
                <input name="taxpayMode" type="text" value="${cgrkorder.taxpayMode}" autocomplete="off" size="30"
                       alt="请输入付税方式"/>
            </p>
            ...
            <p>
                <label>发票号码：</label>
                <input name="invoiceNumber" class="required" type="text" value="${cgrkorder.invoiceNumber}"
                       autocomplete="off" size="30" alt="请输入发票号码"/>
            </p>
            ...
            <p>
                <label>入库数量：</label>
                <input name="quantity" class="required" type="text" value="${cgrkorder.quantity}" autocomplete="off"
                       size="30" alt="请输入入库数量"/>
            </p>

            <p>
                <label>备注</label>
                <textarea name="descript" type="text" value="${cgrkorder.descript}" autocomplete="off" cols="28"
                          alt="请输入备注"></textarea>
            </p>
        </div>
        <div class="formBar">
