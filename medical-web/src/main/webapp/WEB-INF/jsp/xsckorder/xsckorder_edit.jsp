...
<div class="pageContent">
    <form method="post" action="xsckorder/save" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
        <div class="pageFormContent" layoutH="56" autocomplete="off">
            <input type="hidden" name="id" value="${xsckorder.id}"/>
            <p>
                <label>销售出库单编号：</label>
                <input name="code" type="text" size="30" class="required" value="${xsckorder.code}"/>
            </p>

            <p>
                <label>单据日期：</label>
                <input name="billDate" class="date" type="text" readonly="true" value="${xsckorder.billDate}"/>
            ...
            <p>
                ...
                <input type="text" class="required" value="${xsckorder.warehouseName}" name="warehouse.name"
            ...
            <p>
                ...
                <input type="text" class="required" value="${xsckorder.medicineName}" name="medicine.name" rel="lookup"
            ...
            <p>
                ...
                <input type="text" class="required" value="${xsckorder.operatorName}" name="user.username" rel="lookup"
            ...
            <p>
                ...
                <input type="text" class="required" value="${xsckorder.agentName}" name="agent.name" rel="lookup"
            ...
            <p>
                ...
                <input type="text" class="required" value="${xsckorder.commercialCompanyName}"
            ...
            <p>
                <label>销售单价：</label>
                <input name="salePrice" type="text" value="${xsckorder.salePrice}" autocomplete="off" size="30"
                       alt="请输入销售单价"/>
            </p>

            <p>
                <label>付款金额：</label>
                <input name="saleMoney" type="text" value="${xsckorder.saleMoney}" autocomplete="off" size="30"
                       alt="请输入付款金额"/>
            </p>

            <p>
                <label>入库数量：</label>
                <input name="quantity" class="required" type="text" value="${xsckorder.quantity}" autocomplete="off"
                       size="30" alt="请输入入库数量"/>
            </p>

            <p>
                <label>备注</label>
                <textarea name="descript" type="text" value="${xsckorder.descript}" autocomplete="off" cols="28"
                          alt="请输入备注"></textarea>
            </p>
        </div>
        <div class="formBar">
