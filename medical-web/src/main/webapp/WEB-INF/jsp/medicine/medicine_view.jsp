...
<div class="pageContent">
    <form method="post" action="medicine/save" class="pageForm required-validate"
        ...
        <div class="pageFormContent" layoutH="56" autocomplete="off">
            ...
            <p>
                <label>药品代码：</label>
                <input name="uniqueCode" class="required" type="text" autocomplete="off" size="30"
                       value="${medicine.uniqueCode}" readonly/>
            </p>
