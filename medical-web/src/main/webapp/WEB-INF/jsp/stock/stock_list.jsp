...
<div class="pageHeader">
    <form onsubmit="return navTabSearch(this);" action="stock/list" method="post">
        <div class="searchBar">
            <div class="subBar">
                <ul>
...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            ...
            <li><a class="edit" href="stock/view?id={id}" target="dialog" warn="请选择一个库存"><span>详情</span></a></li>
        </ul>
    </div>
