...
<div class="pageContent">
    <form method="post" action="warehouse/save" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
        <div class="pageFormContent" layoutH="56" autocomplete="off">
            <input type="hidden" name="id" value="${warehouse.id}"/>
            <!-- fake fields are a workaround for chrome autofill getting the wrong fields -->
            <p>
                <label>仓库编号：</label>
                <input name="code" class="required" type="text" value="${warehouse.id}" autocomplete=" off" size="30"
