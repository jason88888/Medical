    ...
    <form method="post" action="purchase/client/save" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
        <div class="pageFormContent" layoutH="56" autocomplete="off">
            ...
            <p>
                ...
                <input name="saleCompany" class="required" type="text" autocomplete="off" size="30" alt="请输入我司上家销货单位"/>
            </p>
            <p>
                <label>我司下家购货单位：</label>
                <input name="buyCompany" class="required" type="text" autocomplete="off" size="30" alt="请输入我司下家购货单位"/>
            </p>
            <p>
                <label>为所属客户：</label>
                <input name="clientName"  type="text" autocomplete="off" size="30" alt="请输入为所属客户"/>
            </p>
            <p>
                <label>采购销售区域：</label>
